      ...
      try {
        ...
        if (response.ok) {
          ...
          const transformedProduct: ProductDetail = {
            ...
            colors: Array.isArray(productData.colors) ? productData.colors : (productData.colors ? [productData.colors] : ["Black", "White", "Navy"]),
            sizes: Array.isArray(productData.sizes) ? productData.sizes : STANDARD_SIZES,
